...
| Chat sessions | `display.showChats` |
| Chat: peak/loss alert | `display.chatShowPeakAlert` |
| Chat: total size | `display.chatShowSize` |
| Chat: last active | `display.chatShowLastActive` |
