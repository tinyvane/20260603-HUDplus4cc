...
export type MainDeps = {
  ...
  getSubmoduleConfig: typeof getSubmoduleConfig;
...
export async function main(overrides: Partial<MainDeps> = {}): Promise<void> {
  ...
  try {
    ...
    const mayNeedCompactHint = Boolean(
    ...
    const needsTranscript = mayNeedCompactHint || Boolean(
      display.showTools
      || display.showAgents
      || display.showTodos
    ...
    const transcript: TranscriptData = needsTranscript
